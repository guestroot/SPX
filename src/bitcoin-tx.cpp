...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s SPX-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  SPX-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded SPX transaction") + "\n" +
              "  SPX-tx [options] -create [commands]   " + _("Create hex-encoded SPX transaction") + "\n" +
              "\n";
