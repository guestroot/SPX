...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.SPX.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("SPXtools.com", "dnsseed.SPXtools.com"));
        vSeeds.push_back(CDNSSeedData("SPXpool.org", "dnsseed.SPXpool.org"));
        ...
        fDefauSPXonsistencyChecks = false;
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("SPXtools.com", "testnet-seed.SPXtools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.SPX.loshan.co.uk", true));
...
public:
    CRegTestParams() {
        ...
        fDefauSPXonsistencyChecks = true;
        fRequireStandard = false;
