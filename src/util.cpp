...
const char * const BITCOIN_CONF_FILENAME = "SPX.conf";
const char * const BITCOIN_PID_FILENAME = "SPX.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SPX";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/SPX";
#else
    // Unix
    return pathRet / ".SPX";
#endif
